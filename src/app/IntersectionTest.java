...
public class IntersectionTest {
    ...
    private static boolean vecAlmostEqual(Vec3 a, Vec3 b) {
        if (Util.almostEqual(a.x(), b.x()) && Util.almostEqual(a.y(), b.y()) && Util.almostEqual(a.z(), b.z()))
            return true;
        return false;
    }
    ...
    static void expectHit(String name, Ray r, SphereShape s, double tExp, Vec3 xExp, Vec3 nExp) {
        Hit h = s.intersect(r);
    ...
    static void expectNoHit(String name, Ray r, SphereShape s) {
        Hit h = s.intersect(r);
